...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO `info`(`id`, `cat_name`, `owner_name`, `birthday`, `gender`) VALUES (NULL,'$cat_name','$owner_name','$birthday','$gender')";
...
<body>
   ...
   <div class="container">
      <div class="text-center mb-4">
         <h3>Add New Cat</h3>
         <p class="text-muted">Complete the form below to add a new cat</p>
      </div>
